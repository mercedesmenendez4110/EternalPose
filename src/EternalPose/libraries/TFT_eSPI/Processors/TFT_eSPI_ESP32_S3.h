...
// ESP32 specific SPI port selection
    ...
    // ESP32-S3 Arduino core defines FSPI as 0, which would produce an invalid
    // register base address in TFT_eSPI. Use SPI port 2 for the FSPI register
    // block on ESP32-S3 instead.
    #define SPI_PORT 2
  #endif
#endif
